...
This project is indexed by GitNexus as **frontend-main** (1967 symbols, 3164 relationships, 75 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
