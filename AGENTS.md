...
This project is indexed by GitNexus as **frontend-main** (2255 symbols, 3657 relationships, 108 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
