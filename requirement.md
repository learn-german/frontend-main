...
- [ ] Phase 3b — học viên nhìn thấy group/hint/word-bank khi làm bài nghe/đọc (sửa `QuizSetListPage.tsx`, `ExerciseAnswerInput.tsx`, `ExerciseResultReview.tsx` — hiện đang hiển thị phẳng, không có group/hint/word-bank như ngữ pháp). Cần dữ liệu thật từ Phase 3a để test nên làm sau. Chưa làm.
---
